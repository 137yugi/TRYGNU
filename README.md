...
Phaser + TypeScript + Vite で再構築した、PC/SP対応の短時間サバイバーゲームです。免疫細胞を動かして抗体ヌンチャクの軌道を作り、病原体群・契約・ギフトイベント・大型感染体戦を処理します。1ランは約3分30秒です。
...
6. HPが0になると失敗です。大型感染体撃破、または制限時間生存でラン成功です。
...
- 見た目: `public/assets/pixel/` のドット調SVGを Phaser に読み込み、免疫細胞タイプ、抗体鎖タイプ、病原体、ドロップの見た目に反映します。
